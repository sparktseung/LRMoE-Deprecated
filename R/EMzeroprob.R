...
{
  term.zero = sweep(z.zero.e.obs, 1, sweep(z.zero.e.lat, 1, k.e, FUN = "*", check.margin = FALSE), FUN = "+", check.margin = FALSE)
    # z.zero.e.obs  + sweep(z.zero.e.lat, 1, k.e, FUN = "*", check.margin = FALSE)
  term.pos  = sweep(z.pos.e.obs, 1, sweep(z.pos.e.lat, 1, k.e, FUN = "*", check.margin = FALSE), FUN = "+", check.margin = FALSE)
