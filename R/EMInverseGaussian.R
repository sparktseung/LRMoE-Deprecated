                                   ...
                                   penalty, hyper.params)
{
  ...
  # Take old parameters
  mean.mu = invgauss.params.old[1]
  shape.lambda = invgauss.params.old[2]
  ...
  # Value to return
  invgauss.params.new = invgauss.params.old
  ...
  invgauss.params.new[1] = mean.mu.new
  invgauss.params.new[2] = shape.lambda.new
  return(invgauss.params.new)
