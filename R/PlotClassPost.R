...
#'
#' @seealso \code{\link{LRMoE.fit}}, \code{\link{predict.class.posterior}}
#'
#' @import ggplot2
#'
...
plot.dataset.prob.posterior = function(X, Y, alpha, comp.dist, zero.prob, params.list, title = "Proportion of Latent Classes")
{
  ...
  # New assignments
  assign.class.new = predict.class.posterior(X, Y, alpha, comp.dist, zero.prob, params.list) # predict.class(X, alpha.new)
