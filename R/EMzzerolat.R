...
#' @param comp.kj.zero.inflation TRUE/FALSE. See returned value \code{zero.inflation} in \code{\link{expert.loglik.dim.comp}}.
#' @param comp.kj.zero.prob.old A numeric between 0 and 1. See returned value \code{zero.prob} in \code{\link{expert.loglik.dim.comp}}.
#' @param comp.kj.pos.expert.tn.bar See returned value \code{pos.expert.tn.bar} in \code{\link{expert.loglik.dim.comp}}
#'
...
# #' @export z.zero.e.lat.recur
z.zero.e.lat.recur = function(tl.k, comp.kj.zero.inflation, comp.kj.zero.prob.old, comp.kj.pos.expert.tn.bar)
{
