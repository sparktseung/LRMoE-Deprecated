...
#' }
#'
#' @param hyper.params A vector of parameters penalizations for \code{params}.
#'     As a general rule for simplicity, positive parameters are given Gamma priors, real parameters are
